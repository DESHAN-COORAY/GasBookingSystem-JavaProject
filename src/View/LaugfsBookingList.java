...
public class LaugfsBookingList extends javax.swing.JFrame {

    /** Creates new form LitroSearch*/
    public LaugfsBookingList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("L A U G F S   BOOKINGS LIST");
    ...
    private void displayBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_displayBtnActionPerformed
        ...
        ResultSet r = new DBSearch().searchLaugfsAll();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaugfsBookingList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
